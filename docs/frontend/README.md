...
views import a compact projection of verified bundle `ed37163b61afda5c`, which
contains BTCUSDT and ETHUSDT for all five intervals from 2021-01-01 through the
exclusive 2026-08-15 UTC boundary. The workspace exposes the latest boundary,
