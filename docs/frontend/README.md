...
views import a compact projection of verified bundle `8c4cb901b8ce1adc`, which
contains BTCUSDT and ETHUSDT for all five intervals from 2021-01-01 through the
exclusive 2026-08-16 UTC boundary. The workspace exposes the latest boundary,
