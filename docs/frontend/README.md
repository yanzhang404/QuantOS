...
views import a compact projection of verified bundle `c47a6eac8a76dbd6`, which
contains BTCUSDT and ETHUSDT for all five intervals from 2021-01-01 through the
exclusive 2026-08-14 UTC boundary. The workspace exposes the latest boundary,
