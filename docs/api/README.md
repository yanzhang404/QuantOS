...
| `GET` | `/api/v1/radar/latest` | Read the latest validated A-share stock/theme heat snapshot |
| `GET` | `/api/v1/radar/health` | Read radar refresh success, failure, and derived staleness state |
